    ...
    <section className="py-32 px-6 bg-gradient-to-b from-card to-background">
      <div className="max-w-4xl mx-auto">
        <div className="flex flex-col md:flex-row items-center gap-12">
          {/* Profile Photo */}
          {settings.metadata.profile_photo?.imgix_url && (
            <div className="flex-shrink-0">
              <img
                src={`${settings.metadata.profile_photo.imgix_url}?w=320&h=320&fit=crop&auto=format,compress`}
                alt={settings.metadata.name}
                width={160}
                height={160}
            ...
            <div className="flex items-center justify-center md:justify-start gap-4">
              {settings.metadata.github_url && (
                <a
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 bg-card border border-border rounded-lg text-foreground hover:bg-card-hover hover:border-accent transition-all"
                >
